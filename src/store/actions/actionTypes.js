...
export const GET_TUTORIAL_LIKES_DATA_START = 'GET_TUTORIAL_LIKES_DATA_START';
export const GET_TUTORIAL_LIKES_DATA_SUCCESS = 'GET_TUTORIAL_LIKES_DATA_SUCCESS';
export const GET_TUTORIAL_LIKES_DATA_FAIL = 'GET_TUTORIAL_LIKES_DATA_FAIL';

export const SET_TUTORIAL_USER_CHOICE_START = "SET_TUTORIAL_USER_CHOICE_START";
export const SET_TUTORIAL_USER_CHOICE_SUCCESS = "SET_TUTORIAL_USER_CHOICE_SUCCESS";
export const SET_TUTORIAL_USER_CHOICE_FAIL = "SET_TUTORIAL_USER_CHOICE_FAIL";

export const GET_COMMENT_LIKES_DATA_START = 'GET_COMMENT_LIKES_DATA_START';
export const GET_COMMENT_LIKES_DATA_SUCCESS = 'GET_COMMENT_LIKES_DATA_SUCCESS';
export const GET_COMMENT_LIKES_DATA_FAIL = 'GET_COMMENT_LIKES_DATA_FAIL';

export const SET_COMMENT_USER_CHOICE_START = "SET_COMMENT_USER_CHOICE_START";
export const SET_COMMENT_USER_CHOICE_SUCCESS = "SET_COMMENT_USER_CHOICE_SUCCESS";
export const SET_COMMENT_USER_CHOICE_FAIL = "SET_COMMENT_USER_CHOICE_FAIL";
